...
CKEDITOR.lang["vi"] = {
    ...
    stylescombo: { label: "Kiểu", panelTitle: "Phong cách định dạng", panelTitle1: "Kiểu khối", panelTitle2: "Kiểu trực tiếp", panelTitle3: "Kiểu đối tượng" },
    ...
    scayt: { btn_about: "Thông tin về SCAYT", btn_dictionaries: "Từ điển", btn_disable: "Tắt SCAYT", btn_enable: "Bật SCAYT", btn_langs: "Ngôn ngữ", btn_options: "Tùy chọn", text_title: "Kiểm tra chính tả ngay khi gõ chữ (SCAYT)" },
    removeformat: { toolbar: "Xoá định dạng" },
    pastetext: { button: "Dán theo định dạng văn bản thuần", pasteNotification: "Press %1 to paste. Your browser doesn‘t support pasting with the toolbar button or context menu option.", title: "Dán theo định dạng văn bản thuần" },
    pastefromword: {
    ...
    fakeobjects: { anchor: "Điểm neo", flash: "Flash", hiddenfield: "Trường ẩn", iframe: "IFrame", unknown: "Đối tượng không rõ ràng" },
    ...
    basicstyles: { bold: "Đậm", italic: "Nghiêng", strike: "Gạch xuyên ngang", subscript: "Chỉ số dưới", superscript: "Chỉ số trên", underline: "Gạch chân" },
    about: { copy: "Bản quyền &copy; $1. Giữ toàn quyền.", dlgTitle: "Thông tin về CKEditor 4", moreInfo: "Vui lòng ghé thăm trang web của chúng tôi để có thông tin về giấy phép:" },
