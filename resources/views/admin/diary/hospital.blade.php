            ...
            <div class="col-12">
                <div class="card card-body">
                    <ul class="mb-3 nav nav-pills user-profile-tab mt-2 bg-primary-subtle rounded-2 rounded-top-0" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6 active" href="{{ route('diary.hospital') }}" >
                                <span class="icon-item-icon me-1">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade active show" id="diary-tab2" role="tabpanel" aria-labelledby="diary-tab2" tabindex="0">
                            <form action="">
                                <div class="row mb-2">
                                ...
                                <div class="col-md-12">
                                    <div class="system-table table-responsive">
                                        <table id="simpletable" class="table border text-nowrap customize-table mb-0 align-middle mb-3">
                                            ...
                                            <tbody>
                                                @foreach ($hospitalDiaryList as $key => $hospitalDiary)
                                                <tr>
                                                    <td>
