...
@section('content')
    @include('admin.partial.breadcrumb', ['breadcrumbTitle' => 'Cập nhật thông tin'])
                                    ...
                                    <div class="col-md-10">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade active show" id="v-pills-info" role="tabpanel"
                                                ...
                                                @include('admin.pages.system.components.contract')
                                            </div>
                                            <div class="tab-pane fade" id="v-pills-clientuser" role="tabpanel"
                                                aria-labelledby="v-pills-clientuser-tab">
                                                @include('admin.pages.system.components.customer-group')
                                            </div>
                                        </div>
                                    </div>
                                </div>
