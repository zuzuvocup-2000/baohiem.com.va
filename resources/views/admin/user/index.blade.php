                ...
                <div class="card-body">
                    ...
                    <div class="d-flex no-block justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center">
                            <a class="btn btn-primary d-flex align-items-center me-3" href="{{ route('employee.index') }}">
                                <span class="icon-item-icon">
                                    <img src="/img-system/system/user-group-white.svg" alt="">
                                </span>
                                <span class="ms-1">Danh sách nhân viên</span>
                            </a>
