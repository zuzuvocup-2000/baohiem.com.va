                                                    ...
                                                    <div class="d-flex">
                                                        <div class="form-check me-3">
                                                            <input class="form-check-input account_holder_customer"
                                                                type="radio" name="account_holder" id="info1" value="1"
                                                                checked="" />
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                <tr role="row">
                                                    ...
                                                    <td>
                                                        <input
                                                            class="form-control int create-insurance-expected_payment"
                                                            type="text" value="">
                                                    </td>
                                                    <td>
                                                        <input
