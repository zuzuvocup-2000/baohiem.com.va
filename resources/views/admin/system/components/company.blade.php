<div class="row mb-4">
    <div class="col-xs-12 col-md-6">
        <div class="form-group d-flex align-items-center">
            <label class="d-inline-block" style="width: 100px" for="startDate">Tỉnh/thành</label>
            <select class="form-select contract-province-search mr-sm-2" id="provinceSelect" name="province_id">
