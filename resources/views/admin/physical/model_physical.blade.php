<div id="newPeriodic" class="modal fade" tabindex="-1" aria-labelledby="success-header-modalLabel" aria-hidden="true">
                            ...
                            <ul class="mb-3 nav nav-pills user-profile-tab mt-2 bg-primary-subtle rounded-2 rounded-top-0"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        ...
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick1" type="button"
                                        role="tab" aria-controls="sick1" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick2" type="button"
                                        role="tab" aria-controls="sick2" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick3" type="button"
                                        role="tab" aria-controls="sick3" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick4" type="button"
                                        role="tab" aria-controls="sick4" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick5" type="button"
                                        role="tab" aria-controls="sick5" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick6" type="button"
                                        role="tab" aria-controls="sick6" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick7" type="button"
                                        role="tab" aria-controls="sick7" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick8" type="button"
                                        role="tab" aria-controls="sick8" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick9" type="button"
                                        role="tab" aria-controls="sick9" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick10" type="button"
                                        role="tab" aria-controls="sick10" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick11" type="button"
                                        role="tab" aria-controls="sick11" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick12" type="button"
                                        role="tab" aria-controls="sick12" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="sick-tab" data-bs-toggle="pill" data-bs-target="#sick13" type="button"
                                        role="tab" aria-controls="sick13" aria-selected="false" tabindex="-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-4">
                                                <div class="form-group d-flex align-items-center">
                                                    ...
                                                    <select class="form-select periodic-doctor mr-sm-2 doctorSelect"
                            ...
                            <ul class="mb-3 nav nav-pills user-profile-tab mt-2 bg-primary-subtle rounded-2 rounded-top-0"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        ...
                                        type="button" role="tab" aria-controls="test" aria-selected="true">
