            ...
            <div class="row mb-3">
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 col-xl-4">
                    <div class="btn-input" style="text-align: right;">
                        <button type="button" class="btn btn-warning">Load danh sách</button>
                    </div>
                </div>
            </div>
            </form>
                ...
                <table id="simpletable" class="table border text-nowrap customize-table mb-0 align-middle mb-3">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">29/11/1968</td>
                            <td>Nhân viên, package 2, onshore</td>
                            <td>
                                <div class="btn-group d-flex">
                                    ...
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#newPeriodic">
                                        <span class="icon-item-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-circle-plus"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0"></path><path d="M9 12h6"></path><path d="M12 9v6"></path></svg></span>
                                    </button>
                                </div>
                            </td>
                        </tr>
                            ...
                            <form action="" class="form-physical-detail" method="POST" enctype="multipart/form-data>">
                                                ...
                                                <table id="file" class="table system-table border text-nowrap customize-table mb-0 align-middle mb-3">
                                                    ...
                                                    <tbody>
                                                        <tr role="row">
                                                            <td>
                                                                <div class="btn-group d-flex">
                                                                    <button class="btn btn-info me-1 btn-create-company js-btn-loading">
                                                                        <div class="default ">
                                                                            <span class="icon-item-icon">
                                                            ...
                                                            <td>
                                                                <input class="inputField form-control create-company-name" type="text" name="company_name" value="">
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-4">
                                                        <div class="form-group d-flex align-items-center">
                                                            <label class="d-inline-block" style="width: 150px;" for=""><h5 class="mb-0">Bác sĩ khám:</h5></label>
                                                            <select class="form-select periodic-doctor mr-sm-2 doctorSelect" id="" name="companySelect">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-4">
                                                        <div class="btn-group">
                                                            <button class="btn btn-primary me-2 showDoctorInput" id="" type="button">Thêm bác sĩ</button>
                                                            <button class="btn btn-primary editDoctor" id="" type="button">Sửa bác sĩ</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-4">
                                                        <div class="form-group doctor-name" style="display: none;">
                                                            <label class="d-inline-block" for=""><h5 class="mb-0">Tên bác sĩ:</h5></label>
                                                            <input type="text" class="form-control doctorNameInput" id="" name="doctor-name" />
                                                            <button type="button" class="btn btn-warning btn-add-doctor addDoctor" id="">OK</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table id="diagnosticTable" class="table border table-striped table-bordered text-nowrap align-middle dataTable">
                                                    <thead class="text-dark fs-4">
                                                        <tr role="row">
                                                            <th></th>
                                                            <th>
                                                                <h6 class="fs-4 fw-semibold mb-0 text-center">Phân loại xét nghiệm</h6>
                                                            </th>
                                                            <th>
                                                                <h6 class="fs-4 fw-semibold mb-0 text-center">Tên xét nghiệm</h6>
                                                            </th>
                                                            <th>
                                                ...
                                                <table id="diagnosticImage" class="table border table-striped table-bordered text-nowrap align-middle dataTable">
                                                    <thead class="text-dark fs-4">
                                                        <tr role="row">
                                                            <th></th>
                                                            <th>
                                                                <h6 class="fs-4 fw-semibold mb-0 text-center">Phân loại CDHA</h6>
                                                            </th>
                                                            <th>
                                ...
                                <div class="card card-body note-has-grid">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-xs-12 col-md-12 col-xl-6">
                                            <div class="form-group">
                                                <label><h5>Bác sĩ kết luận:</h5></label>
                                                <div class="col-sm">
                                                    <input type="text" class="form-control input-modal-account" value="" name="KETLUAN">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-12 col-xl-6">
                                            <div class="form-group">
                                                <label><h5>Nơi khám:</h5></label>
                                                <div class="col-sm">
                                                    <input type="text" class="form-control input-modal-account" value="" name="NOIKHAM">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
