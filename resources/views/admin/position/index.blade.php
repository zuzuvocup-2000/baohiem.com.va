...
@section('title', 'Quản lý vị trí chức vụ')

@section('content')
    @include('partial.breadcrumb', ['breadcrumbTitle' => 'Quản lý vị trí chức vụ'])
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex mb-2 align-items-center justify-content-between">
                                <div>
                                    <h5 class="mb-0">Danh sách vị trí chức vụ</h5>
                                </div>
                                        ...
                                        <table id="simpletable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr data-id="{{ $position->id }}">
                                                    ...
                                                    <td>
                                                        <input class="inputField form-control" type="text" name="update_name" value="{{ $position->name }}" data-original-value="{{ $position->name }}" disabled="">
                                                    </td>
                                                    <td>
                                                        <h6 class="fs-4 fw-semibold mb-0">
                                                            <div class="btn-group d-flex">
                                                                ...
                                                                <button class="btn btn-danger tabledit-delete-button delete-button-position">
                                                                    <span class="icon-item-icon">
                                                                        <img src="{{ asset('/img-system/system/trash_white.svg') }}" alt="">
                                                                    </span>
                                                                </button>
                                                                <button class="btn btn-info me-1 saveButton btn-update-position" style="display: none;">
                                                                    <span class="icon-item-icon">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addpositionModalLabel">Thêm vị trí chức vụ mới</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addpositionForm">
                        <div class="mb-3">
                            <label for="positionName" class="form-label">Tên vị trí chức vụ:</label>
                            <input type="text" class="form-control" id="positionName" name="create_name">
                        </div>
                        <button type="submit" class="btn-create-position btn btn-success">Thêm mới</button>
                    </form>
                </div>
            </div>
        </div>
...
@endsection
@section('script')
<script src="/js/pages/position.js"></script>
@endsection
