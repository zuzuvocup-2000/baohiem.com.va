...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead d-flex no-block justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('role.create') }}" class="btn btn-success d-flex align-items-center btn-sm float-right">
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="{{ route('role.show', $role->id) }}">
                                <span class="icon-item-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-eye-cog" width="24" height="24"
                            ...
                            <a class="btn btn-primary btn-sm" href="{{ route('role.edit', $role->id) }}">
