        ...
        <div class="container mt-4">
            ...
            <form method="POST" action="{{ route('permissions.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('name') }}" type="text" class="form-control" name="name" placeholder="Tên quyền"
                        required>
                ...
                <div style="text-align: right;">
                    ...
                    <a class="btn btn-primary btn-sm" href="{{ route('permissions.index') }}" class="btn btn-default">
