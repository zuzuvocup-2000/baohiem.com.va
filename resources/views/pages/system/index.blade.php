                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="inlineFormCustomSelect">Tên công
                                                                ty</label>
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="inlineFormCustomSelect">Niên
                                                                hạn</label>
                                                            <select class="form-select mr-sm-2"
                                                                id="inlineFormCustomSelect">
                                                    ...
                                                    <table id="simpletable"
                                                        ...
                                                        <thead class="text-dark fs-4">
                                                            <tr role="row">
                                                                <th>
                                                                    <input type="checkbox"
                                                                        class="toggleAll custom-control-input"
                                                                        id="customCheck1" />
                                                                </th>
                                                                <th>
                                                        ...
                                                        <tbody>
                                                            <tr role="row" data-id="24">
                                                                <td>
                                                                    <input type="checkbox"
                                                                        class="toggleCheckbox custom-control-input"
                                                                        id="" name="" value="" />
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <input class="inputField form-control" type="text"
                                                                        name="company" value="DH Cuu Long 2023"
                                                                        data-original-value="DH Cuu Long 2023"
                                                                        disabled="" />
                                                                </td>
                                                                <td>
                                                                    <input class="inputField form-control" type="text"
                                                                        name="address" value="01/2022HĐ CL"
                                                                        data-original-value="01/2022HĐ CL"
                                                                        disabled="" />
                                                                </td>
                                                                <td>
                                                                    <div class="input-group">
                                                                        <input type="text"
                                                                            class="inputField form-control singledate"
                                                                            value="01/01/2023" disabled="" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="input-group">
                                                                ...
                                                                <td>
                                                                    <div class="input-group">
                                                                        <input type="text"
                                                                            class="inputField form-control singledate"
                                                                            value="31/12/2023" disabled="" />
                                                                    </div>
                                                                </td>
                                                                <td class="text-center">
                                                                    <input type="checkbox"
                                                                        class="inputField custom-control-input"
                                                                        id="customCheck1" disabled="" />
                                                                </td>
                                                                <td>
                                                                    <input class="inputField form-control" type="text"
                                                                        name="address" value="0"
                                                                        data-original-value="0" disabled="" />
                                                                </td>
                                                                <td>
                                                                    <h6 class="fs-4 fw-semibold mb-0">
                                                                        <div class="btn-group d-flex">
                                                                            <button
                                                                                class="btn btn-success me-1 editButton">
                                                                            ...
                                                                            <button
                                                                                class="btn btn-danger tabledit-delete-button"
                                                                                data-id="24">
                                                                                <span class="icon-item-icon">
                                                            ...
                                                            <tr role="row">
                                                                ...
                                                                <td>
                                                                    <input class="inputField form-control singledate"
                                                    ...
                                                    <table id="simpletable"
                                                        ...
                                                        <tbody>
                                                            <tr role="row" data-id="24">
                                                                ...
                                                                <td>
                                                                    <input class="inputField form-control" type="text"
                                                                        name="insurance_name" value="VIP"
                                                                        data-original-value="VIP" style="width: 100%;"
                                                                        disabled="" />
                                                                </td>
