    ...
    <table id="simpletable" class="table system-table border text-nowrap customize-table mb-0 align-middle mb-3">
        ...
        <tbody>
            <tr role="row" data-id="24">
                <td>
                    <input type="checkbox" class="toggleCheckbox custom-control-input" id="" name=""
                        value="" />
                </td>
                <td>
                ...
                <td>
                    <input class="inputField form-control" type="text" name="insurance_name" value="PVFCCO"
                        data-original-value="PVFCCO" disabled="" />
                </td>
                <td>
                    <input class="inputField form-control" type="text" name="value" value="0"
            ...
            <tr role="row">
                ...
                <td>
                    <input class="inputField form-control" type="text" name="value" value=""
                        data-original-value="" />
                </td>
                <td>
                    <input class="inputField form-control" type="text" name="note" value=""
