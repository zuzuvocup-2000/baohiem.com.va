                ...
                <tr role="row" data-id="{{ $packageDetail->id }}">
                    ...
                    <td>
                        <input class="inputField form-control" type="text" name="package_name"
                            ...
                            data-original-value="{{ $packageDetail->package_name }}" disabled="" />
                    </td>
                    <td>
                        <input class="inputField form-control" type="text" name="package_price"
                            value="{{ $packageDetail->package_price }}"
                            data-original-value="{{ $packageDetail->package_price }}" disabled="" />
                    </td>
                    <td>
                        <input class="inputField form-control" type="text" name="note"
                            value="{{ $packageDetail->note }}" data-original-value="{{ $packageDetail->note }}"
                            disabled="" />
                    </td>
                    <td>
